...
| [`Weather_Chatbot_API`]((https://github.com/itz-Harsh/Weather_ChatBot__FlaskAPI)) |  A simple Weather Chatbot built with Flask, OpenWeatherMap API, and a modern animated UI | Python , Flask , Basic Web |
